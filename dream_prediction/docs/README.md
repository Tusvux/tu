...
- Lưu mô hình tốt nhất vào `mo_hinh_tot_nhat_vn.pkl`
...
```
dream_prediction/
├── generate_data_4_classes.py          # Tạo dữ liệu mẫu
├── train_model_vn.py            # Huấn luyện mô hình
├── predict_vn.py                # Dự đoán
├── requirements.txt          # Dependencies
├── README.md                 # Tài liệu này
├── dream_data.csv           # Dữ liệu (sau khi chạy generate_data_4_classes.py)
